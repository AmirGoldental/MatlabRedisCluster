...
other_button = uicontrol(fig, 'Style', 'pushbutton', 'BackgroundColor', '#DD2C00',...
    'String', 'Delete task(s)', 'Units', 'normalized', 'Position', [0.01 0.17 0.1 0.0499],...
...
details_button = uicontrol(fig, 'Style', 'pushbutton', 'BackgroundColor', '#303F9F',...
    'String', 'View details', 'Units', 'normalized', 'Position', [0.01 0.12 0.1 0.0499],...
...
refresh_button = uicontrol(fig, 'Style', 'pushbutton', 'BackgroundColor', '#009688',...
    'String', 'Refresh', 'Units', 'normalized', 'Position', [0.01 0.07 0.1 0.0499],...
    'callback', @(~,~) refresh(), 'ForegroundColor', 'w', 'FontName', 'Consolas', 'FontSize', 12);

flush_button = uicontrol(fig, 'Style', 'pushbutton', 'BackgroundColor', '#DD2C00',...
    'String', 'Restart Cluster', 'Units', 'normalized', 'Position', [0.01 0.02 0.1 0.0499],...
    'callback', @(~,~) mrr.flush_db(), 'ForegroundColor', 'w', 'FontName', 'Consolas', 'FontSize', 12);
